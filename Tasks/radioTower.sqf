...
//Get position
while{_ok == 0}do{
	_location = [0,0,townMarkers,1,0,0,[1,0,10],0,0,[1,5,5],[1,[0,0,0],10]] call Zen_FindGroundPosition;
	_nearestPlayers = [];
	{
...
(group tower) setVariable ["zbe_cacheDisabled",true];
...
//Create task
_task = [west,"An enemy radio tower is blocking our communications. Destroy it ASAP","Destroy radio tower",_location,false,"",_name] call Zen_InvokeTask;
