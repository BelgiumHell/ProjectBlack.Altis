...
waitUntil {
    ...
    (([_vehicle] call Zen_IsReady) || ((([_vehicle, _inPos] call Zen_Find2dDistance) < 25) && (speed _vehicle < 1)) || _isCrash || ((_vehicle isKindOf "SHIP") && ((getTerrainHeightASL getPosATL _vehicle) > -1)))
};
