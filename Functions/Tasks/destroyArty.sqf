...
//Get position
while{_ok == 0}do{
    _location = [0,0,occupiedMarkers,1,0,0,[1,0,10],0,0,[1,5,5],[1,[10,-1,-1],120]] call Zen_FindGroundPosition;
    _nearestPlayers = [];
    {
...
//Create task
_task = [west,"Russian forces have set up an artillery emplacement.","Destroy artillery battery",_location,true,"",_name] call Zen_InvokeTask;
